    ...
    return (
        <section className="px-4 mx-auto flex justify-between items-center py-12 md:py-32">
            <div className="container mx-auto">
                <h2 className="text-4xl font-bold mb-11 rubik text-primary-foreground text-center">Popular Categories</h2>
                    ...
                    {categories.map((category) => (
                        <Card key={category} className="shadow-sm p-0">
                            ...
                            <CardFooter className="flex justify-end items-center py-4">
                                <Button
                                    variant="link"
                                    className="font-semibold font-mono text-primary-foreground underline hover:text-blue-600"
                                >
                                    Learn Now
                                </Button>
                            </CardFooter>
