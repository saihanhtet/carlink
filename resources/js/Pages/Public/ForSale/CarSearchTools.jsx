    ...
    <div className="grid grid-cols-2 lg:grid-cols-6 grid-rows-[auto_auto_auto_auto_auto_auto] lg:grid-rows-[auto_auto_auto] gap-2">
      ...
      <div className="col-span-2 lg:col-span-2">
        <Select className="w-full">
          <SelectTrigger className="w-full border border-gray-400 rounded-none ring-offset-0 focus:outline-none focus:ring-0 focus:ring-transparent focus:ring-offset-0">
      ...
      <TextInput
        type="text"
        placeholder={zipCode ? `ZIP: ${zipCode}` : "Enter ZIP"}
        value={zipCode || ""}
        className="col-span-2 lg:col-span-1 border border-gray-400 rounded-none px-4 py-2 ring-offset-0 h-10 focus:outline-none focus:ring-0 focus:ring-transparent focus:ring-offset-0"
      />
